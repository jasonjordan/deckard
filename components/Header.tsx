...
import { ComputerDesktopIcon, PlusCircleIcon, MagnifyingGlassIcon } from './icons';
...
export const Header: React.FC<HeaderProps> = ({ deviceCount, onAddDevice, onScanNetwork, onEndSession }) => {
    return (
            ...
            <div className="flex items-center gap-4">
                <span className="text-sm text-slate-400">{deviceCount} device{deviceCount !== 1 ? 's' : ''} connected</span>
                 <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-slate-700 text-white font-semibold rounded-lg hover:bg-slate-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-indigo-500"
                >
